...
# Remove Gutenberg blocks and patterns
wp option update use_block_editor_for_post_type_post 0 --allow-root
wp option update use_block_editor_for_post_type_page 0 --allow-root
